 ...
 * @date 21/01/2035 
 */
public class AccountManagerTest_Ex11 {
	...
	public void testTransfereValor_SaldoNegativoParaNegativo() {
		...
		int idConta02 = 2;
		CurrentAccount conta01 = new CurrentAccount(idConta01, -100, true);
		CurrentAccount conta02 = new CurrentAccount(idConta02, -100, true);
	...
	public void testTransfereValor_Nenhum() {
		...
		/* ========== Execu��o ========== */
		boolean sucesso = gerContas.transferValue(idConta01, 2, idConta02);
